...
const Hero = () => {
  return (
    <div className="h-[83vh] flex flex-col md:flex-row items-center justify-center">
      ...
      <div className="w-full lg:w-3/6 h-auto lg:h-[100%] flex flex-items-center justify-center">
        <img
